...
const ProduitTable = () => {
    ...
    const [data, setData] = useState<ProduitInterface[] | null>(null);
    ...
    const getProduit = async () => {
        try {
            const response = await produitService.getProduit() as ProduitInterface;
            ...
            <table className="w-full text-sm text-left text-gray-500">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" className="px-6 py-3">Pharmacie</th>
                    </tr>
                </thead>
                <tbody>
                    {Array.isArray(data) &&
