...
const CommuneTableau = () => {
    const [searchTerm, setSearchTerm] = useState("");
    const [data, setData] = useState<CommuneInterface[] | null>(null);
            ...
            <table className="w-full text-sm text-left text-gray-500">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" className="px-6 py-3">Nom du commune</th>
                        <th scope="col" className="px-6 py-3">Nom de ville</th>
