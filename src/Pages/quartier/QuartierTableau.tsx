...
const QuartierTableau = () => {
    const [searchTerm, setSearchTerm] = useState("");
    const [data, setData] = useState<QuartierInterface[] | null>(null);
    ...
    const getQuartier = async () => {
        try {
            const response = await quartierService.getQuartier() as CommuneInterface;
            ...
            <table className="w-full text-sm text-left text-gray-500">
                <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" className="px-6 py-3">Nom de quartier</th>
                        <th scope="col" className="px-6 py-3">Nom de Commune</th>
...
export default QuartierTableau